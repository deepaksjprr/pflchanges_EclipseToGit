...
public class TS16_Contact_length_validation_on_custom_address extends BaseTest {
	...
	public void TS_16_DataSet_Creation() throws Exception {
		...
		Log.startTestCase("TS16_Contact_length_validation_on_custom_address");
		...
		adminpage.create_new_program(program_name, admin_bd_auto_product_1, product_qty, product_count, admin_pfl_bd_auto_user_first_name);
